...
prefix = '/rwproject/kdd-db/20-rayw1/FakeNewsNet/code/'
# prefix = '/Users/shanglinghsu/Workspaces/fyp/'
ds_path = prefix + 'fakenewsnet_dataset'
dataset = ['politifact', 'gossipcop']
subset = ['fake', 'real']

downloaded_image_dir = '/rwproject/kdd-db/20-rayw1/FakeNewsNet/top_images'
